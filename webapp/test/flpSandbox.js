		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cmdemocustomer-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cmdemocustomer-display": {
								"semanticObject": "cmdemocustomer",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cm.demo.customer",
									"url": sap.ui.require.toUrl("cm/demo/customer")
								}
							}
						}
					}
